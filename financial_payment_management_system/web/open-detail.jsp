                    ...
                    <div class="am-u-sm-12 am-u-md-6">
                        <form class="am-form am-form-horizontal">
                            <div class="am-form-group" id="ticketopen-status">
                                ...
                                <div id="ticketInfoviewUitlity-status" class="am-u-sm-9"
                                     style="margin-top: 4px;font-size: 16px;">
                                    ${ticketInfoviewUitlity.status}<span id="review-the-information"
                                                                         style="font-size: 12px;color: #999;margin-left: 5px;"></span>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="am-u-sm-12 am-u-md-6">
                        <form class="am-form am-form-horizontal">
                            <div class="am-form-group" id="expriy-Time">
                                <%--@declare id="user-name"--%><label for="user-name" class="am-u-sm-3 am-form-label">到期日期</label>
                                <div class="am-u-sm-9" style="margin-top: 4px;font-size: 16px;">
